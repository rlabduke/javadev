/* GnuAbstractMap.java -- Abstract implementation of most of Map
 ...
 * GnuAbstractMap and implement the <code>entrySet</code> (usually via an
 * GnuAbstractSet).  To make it modifiable, also implement <code>put</code>,
 ...
 */
public abstract class GnuAbstractMap implements Map
{
   ...
   * not call <code>GnuAbstractMap.clear</code> unless you want an infinite loop.
   *
  ...
  {
    GnuAbstractMap copy = (GnuAbstractMap) super.clone();
   ...
   * <p>
   *
   * This implementation creates an GnuAbstractSet, where the iterator wraps
  ...
  public Set keySet()
  {
    if (keys == null)
      keys = new GnuAbstractSet()
      {
        public int size()
        {
          return GnuAbstractMap.this.size();
        }
   ...
   * <p>
   *
   * This implementation creates an GnuAbstractCollection, where the iterator
  ...
  static class BasicMapEntry implements Map.Entry
  {
      ...
      if (o instanceof BasicMapEntry)
        {
          ...
          return (GnuAbstractMap.equals(key, e.key)
                  && GnuAbstractMap.equals(value, e.value));
        }
      Map.Entry e = (Map.Entry) o;
      return (GnuAbstractMap.equals(key, e.getKey())
              && GnuAbstractMap.equals(value, e.getValue()));
    }
    ...
    {
      return (GnuAbstractMap.hashCode(key) ^ GnuAbstractMap.hashCode(value));
    }
