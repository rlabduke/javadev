/* GnuHashSet.java -- a class providing a GnuHashMap-backed Set
...
/**
 * This class provides a GnuHashMap-backed implementation of the Set interface.
 * <p>
 *
 ...
 * <p>
 *
 * GnuHashSet accepts the null key and null values.  It is not synchronized,
 * so if you need multi-threaded access, consider using:<br>
 * <code>Set s = Collections.synchronizedSet(new GnuHashSet(...));</code>
 * <p>
 *
 ...
 */
public class GnuHashSet extends GnuAbstractSet
  implements Set, Cloneable, Serializable
{
  ...
  /**
   * The GnuHashMap which backs this Set.
   */
  private transient GnuHashMap map;
  ...
  public GnuHashSet()
  {
    this(GnuHashMap.DEFAULT_CAPACITY, GnuHashMap.DEFAULT_LOAD_FACTOR);
  }
   ...
   */
  public GnuHashSet(int initialCapacity)
  {
    this(initialCapacity, GnuHashMap.DEFAULT_LOAD_FACTOR);
  }
   ...
   */
  public GnuHashSet(int initialCapacity, float loadFactor)
  {
   ...
   */
  public GnuHashSet(Collection c)
  {
    this(Math.max(2 * c.size(), GnuHashMap.DEFAULT_CAPACITY));
    addAll(c);
  }
  ...
  public Object clone()
  {
    GnuHashSet copy = null;
    try
      {
        copy = (GnuHashSet) super.clone();
      }
    catch (CloneNotSupportedException x)
      {
        // Impossible to get here.
      }
    copy.map = (GnuHashMap) map.clone();
    return copy;
  }
  ...
  public Iterator iterator()
  {
    ...
    return map.iterator(GnuHashMap.KEYS);
  }
  ...
  {
    return new GnuHashMap(capacity, load);
  }
  ...
  private void writeObject(ObjectOutputStream s) throws IOException
  {
    ...
    // Avoid creating intermediate keySet() object by using non-public API.
    Iterator it = map.iterator(GnuHashMap.KEYS);
