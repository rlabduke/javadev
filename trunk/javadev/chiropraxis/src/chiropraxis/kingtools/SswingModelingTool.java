...
//##############################################################################
    /** The model manager */
    protected SswingManager     modelman;
//}}}

//{{{ Constructor(s)
//##############################################################################
    /**
    * @throws RuntimeException if the SswingManager plugin cannot be found
    */
    public SswingModelingTool(ToolBox tb)
    {
        super(tb);
        ...
        for(Iterator iter = plugins.iterator(); iter.hasNext(); )
        {
            ...
            //if(SswingManager.class.equals(plugin.getClass()))
            if(plugin instanceof SswingManager)
                modelman = (SswingManager)plugin;
        }
        if(modelman == null)
...
//##################################################################################################
    /**
    * All modelling tools are dependent on the SswingManager plugin.
    */
    static public Collection getDependencies()
    {
        ...
        dep.add(SswingManager.class.getName());
        return dep;
    }
//}}}
