...
//######################################################
	...
	System.out.println(df.format(params[0]));
	System.out.println(df.format(params[1]));
	System.out.println(df.format(params[2]));
	System.out.println(df.format(params[3]));
	System.out.println(df.format(params[4]));	
	System.out.println(df.format(params[5]));
	return params;
    }

    public static ArrayList calphaAnalyzeList(KPoint ca0, KPoint ca1, KPoint caN, KPoint caN1, KPoint co1, KPoint coN) {
	double[] results = calphaAnalyze(ca0, ca1, caN, caN1, co1, coN);
