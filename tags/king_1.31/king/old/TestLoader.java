...
//}}}
/**
* <code>TestLoader</code> has not yet been documented.
*
* <p>Copyright (C) 2003 by Ian W. Davis. All rights reserved.
* <br>Begun on Mon Feb 17 16:12:31 EST 2003
*/
public class TestLoader //extends ... implements ...
{
//{{{ Constants
//}}}
...
//##################################################################################################
    ...
    */
    public void Main()
    {
        KinReader r = new KinReader();
        try {
            r.testLoadURLs(myfile.toURL());
    ...
    {
        TestLoader mainprog = new TestLoader();
        try
        {
...
//##################################################################################################
    ...
    */
    void parseArguments(String[] args)
    {
        ...
        InputStream is = getClass().getResourceAsStream("/rc/TestLoader.props");
        try { props.load(is); } catch(IOException ex) {ex.printStackTrace();}
        // User properties from home dir -- may be present
        File userfile = new File(System.getProperty("user.home")+System.getProperty("file.separator")+".TestLoader.props");
        ...
        File localfile = new File(System.getProperty("user.dir")+System.getProperty("file.separator")+"TestLoader.props");
        // Load user properties from file, if found
        if(localfile.exists())
        {
            try {
    ...
    void showHelp(boolean showAll)
    {
        if(showAll)
        {
            InputStream is = getClass().getResourceAsStream("/rc/TestLoader.help");
            if(is == null) System.err.println("\n*** Unable to locate help information in '/rc/TestLoader.help' ***\n");
            else
            {
        ...
        //System.err.println("king.TestLoader, version "+Version.VERSION+" (build "+Version.BUILD+")");
