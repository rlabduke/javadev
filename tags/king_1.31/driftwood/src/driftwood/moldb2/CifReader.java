...
//{{{ Constructor(s)
//##############################################################################
    public CifReader(StarFile docObjMdl)
    {
        super();
        this.dom = docObjMdl;
    }
...
//##############################################################################
    ...
    */
    ...
    {
        // XXX-FIXME: This shouldn't be null!!!
        CifReader mainprog = new CifReader(null);
        try
        {
...
//##############################################################################
    ...
    */
    ...
    void showHelp(boolean showAll)
    {
        if(showAll)
        {
            InputStream is = getClass().getResourceAsStream("CifReader.help");
            if(is == null)
                System.err.println("\n*** Unable to locate help information in 'CifReader.help' ***\n");
            else
            {
        ...
        System.err.println("driftwood.moldb2.CifReader");
