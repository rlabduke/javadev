...
*/
public class BackrubTool extends ModelingTool implements Remodeler, ChangeListener
{
//{{{ Constants
...
//##################################################################################################
    private void buildGUI()
    {
        ...
        toolpane.addCell(cbIdealizeSC, 3, 1);
...
//##################################################################################################
    ...
    public void c_click(int x, int y, KPoint p, MouseEvent ev)
    {
        ...
        else if(p != null)
        {
            ...
            this.ctrRes = this.getResidueNearest(model, state,
...
//##################################################################################################
    ...
    void grabResidues()
    {
        ...
        {
            // Couldn't connect, so start over -- should never happen!
