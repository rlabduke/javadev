...
//{{{ Color map
//##################################################################################################
    private static final Map<String, KPaint> stdColorMap;   // unmodifiable once created
    private static final Map<String, KPaint> fullColorMap;  // unmodifiable once created
...
//##################################################################################################
    ...
    */
    static public Map<String, KPaint> getStandardMap()
    { return stdColorMap; }
    ...
    */
    static public Map<String, KPaint> getFullMap()
    { return fullColorMap; }
//}}}
...
//##################################################################################################
    ...
    */
    ...
    {
        for(KPaint p : getFullMap().values())
            p.setContrast(alpha);
    }
//}}}
